...
import arcanist.entities.CrusherObjectEntity;
...
//I copied ProcessingForgeObjectEntity and changed it slightly
public class CrusherObject extends GameObject implements SettlementWorkstationObject {
    public GameTexture texture;

    public CrusherObject() {
    ...
    public int getLightLevel(Level level, int layerID, int tileX, int tileY) {
        CrusherObjectEntity forgeObjectEntity = this.getForgeObjectEntity(level, tileX, tileY);
    ...
    public void addDrawables(List<LevelSortedDrawable> list, OrderableDrawables tileList, Level level, int tileX, int tileY, TickManager tickManager, GameCamera camera, PlayerMob perspective) {
        ...
        CrusherObjectEntity objectEntity = this.getForgeObjectEntity(level, tileX, tileY);
    ...
    public ListGameTooltips getItemTooltips(InventoryItem item, PlayerMob perspective) {
        ...
        tooltips.add(Localization.translate("itemtooltip", "crusher_tip"));
        return tooltips;
    }

    public CrusherObjectEntity getForgeObjectEntity(Level level, int tileX, int tileY) {
