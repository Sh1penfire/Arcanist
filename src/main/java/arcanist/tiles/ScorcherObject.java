...
import arcanist.entities.ScorcherObjectEntity;
...
public class ScorcherObject extends GameObject implements SettlementWorkstationObject {
    public GameTexture texture;

    public ScorcherObject() {
    ...
    public int getLightLevel(Level level, int layerID, int tileX, int tileY) {
        ScorcherObjectEntity forgeObjectEntity = this.getForgeObjectEntity(level, tileX, tileY);
    ...
    public void addDrawables(List<LevelSortedDrawable> list, OrderableDrawables tileList, Level level, int tileX, int tileY, TickManager tickManager, GameCamera camera, PlayerMob perspective) {
        ...
        ScorcherObjectEntity objectEntity = this.getForgeObjectEntity(level, tileX, tileY);
    ...
    public ObjectEntity getNewObjectEntity(Level level, int x, int y) {
        return new ScorcherObjectEntity(level, x, y);
    }
    ...
    public ListGameTooltips getItemTooltips(InventoryItem item, PlayerMob perspective) {
        ...
        tooltips.add(Localization.translate("itemtooltip", "scorcher_tip"));
        return tooltips;
    }

    public ScorcherObjectEntity getForgeObjectEntity(Level level, int tileX, int tileY) {
        ObjectEntity objectEntity = level.entityManager.getObjectEntity(tileX, tileY);
        return objectEntity instanceof ScorcherObjectEntity ? (ScorcherObjectEntity)objectEntity : null;
    }
